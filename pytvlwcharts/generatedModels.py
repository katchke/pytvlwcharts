...
class CrosshairLineOptions(JsonOptions):
    ...
    color: Optional[str] = None
    label_background_color: Optional[str] = field(
        default=None, metadata=alias("labelBackgroundColor")
    )
...
class CrosshairOptions(JsonOptions):
    ...
    horz_line: Optional[CrosshairLineOptions] = field(
        default=None, metadata=alias("horzLine")
    )
    mode: Optional[CrosshairMode] = None
    vert_line: Optional[CrosshairLineOptions] = field(
        default=None, metadata=alias("vertLine")
    )
...
class GridOptions(JsonOptions):
    ...
    horz_lines: Optional[GridLineOptions] = field(
        default=None, metadata=alias("horzLines")
    )
    vert_lines: Optional[GridLineOptions] = field(
        default=None, metadata=alias("vertLines")
    )
...
class HandleScaleOptions(JsonOptions):
    ...
    axis_double_click_reset: Optional[bool] = field(
        default=None, metadata=alias("axisDoubleClickReset")
    )
    axis_pressed_mouse_move: Optional[Union[AxisPressedMouseMoveOptions, bool]] = field(
        default=None, metadata=alias("axisPressedMouseMove")
    )
...
class HandleScrollOptions(JsonOptions):
    ...
    horz_touch_drag: Optional[bool] = field(
        default=None, metadata=alias("horzTouchDrag")
    )
    mouse_wheel: Optional[bool] = field(default=None, metadata=alias("mouseWheel"))
    pressed_mouse_move: Optional[bool] = field(
        default=None, metadata=alias("pressedMouseMove")
    )
    vert_touch_drag: Optional[bool] = field(
        default=None, metadata=alias("vertTouchDrag")
    )
...
class LayoutOptions(JsonOptions):
    ...
    background_color: Optional[str] = field(
        default=None, metadata=alias("backgroundColor")
    )
...
class LocalizationOptions(JsonOptions):
    ...
    price_formatter: Optional[PriceFormatterFn] = field(
        default=None, metadata=alias("priceFormatter")
    )
    time_formatter: Optional[TimeFormatterFn] = field(
        default=None, metadata=alias("timeFormatter")
    )
...
class __type(JsonOptions):
    ...
    border_visible: Optional[bool] = field(
        default=None, metadata=alias("borderVisible")
    )
    draw_ticks: Optional[bool] = field(default=None, metadata=alias("drawTicks"))
    entire_text_only: Optional[bool] = field(
        default=None, metadata=alias("entireTextOnly")
    )
    ...
    scale_margins: Optional[PriceScaleMargins] = field(
        default=None, metadata=alias("scaleMargins")
    )
...
class TimeScaleOptions(JsonOptions):
    ...
    lock_visible_time_range_on_resize: Optional[bool] = field(
        default=None, metadata=alias("lockVisibleTimeRangeOnResize")
    )
    min_bar_spacing: Optional[int] = field(
        default=None, metadata=alias("minBarSpacing")
    )
    right_bar_stays_on_scroll: Optional[bool] = field(
        default=None, metadata=alias("rightBarStaysOnScroll")
    )
    right_offset: Optional[int] = field(default=None, metadata=alias("rightOffset"))
    seconds_visible: Optional[bool] = field(
        default=None, metadata=alias("secondsVisible")
    )
    shift_visible_range_on_new_bar: Optional[bool] = field(
        default=None, metadata=alias("shiftVisibleRangeOnNewBar")
    )
    tick_mark_formatter: Optional[TickMarkFormatter] = field(
        default=None, metadata=alias("tickMarkFormatter")
    )
...
class ChartOptions(JsonOptions):
    ...
    handle_scale: Optional[Union[HandleScaleOptions, bool]] = field(
        default=None, metadata=alias("handleScale")
    )
    handle_scroll: Optional[Union[HandleScrollOptions, bool]] = field(
        default=None, metadata=alias("handleScroll")
    )
    height: Optional[Union[int, float, str]] = None
    kinetic_scroll: Optional[KineticScrollOptions] = field(
        default=None, metadata=alias("kineticScroll")
    )
    layout: Optional[LayoutOptions] = None
    left_price_scale: Optional[VisiblePriceScaleOptions] = field(
        default=None, metadata=alias("leftPriceScale")
    )
    localization: Optional[LocalizationOptions] = None
    overlay_price_scales: Optional[OverlayPriceScaleOptions] = field(
        default=None, metadata=alias("overlayPriceScales")
    )
    price_scale: Optional[PriceScaleOptions] = field(
        default=None, metadata=alias("priceScale")
    )
    right_price_scale: Optional[VisiblePriceScaleOptions] = field(
        default=None, metadata=alias("rightPriceScale")
    )
    time_scale: Optional[TimeScaleOptions] = field(
        default=None, metadata=alias("timeScale")
    )
